...
namespace Math
{
	...
	Mat4 Inverse(const Mat4& m)
	{
		...
		Mat4 result(
			cofactors1.x, cofactors2.x, cofactors3.x, cofactors4.x,
			cofactors1.y, cofactors2.y, cofactors3.y, cofactors4.y,
			cofactors1.z, cofactors2.z, cofactors3.z, cofactors4.z,
			cofactors1.w, cofactors2.w, cofactors3.w, cofactors4.w);
	...
	Math::Mat4 Orthographic(double left, double right, double bottom, double top, double sLeft, double sRight, double sBottom, double sTop)
	{
		Mat4 result;
