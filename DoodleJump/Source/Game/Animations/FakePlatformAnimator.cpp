	...
	: m_Owner(owner)
{
	...
	m_AnimMachine->SetStateAnimation("break", AssetManager::Get().GetAsset<Animation>("A_PlatformBreak"));
	m_AnimMachine->SetStateAnimation("idle", AssetManager::Get().GetAsset<Animation>("A_PlatformIdle"));
